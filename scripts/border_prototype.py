...
#
# # 2 class
# # border_point_05 = np.array([np.array([np.amax(embed_list[0], axis=0)[0], np.amax(embed_list[0], axis=0)[1]])
# #                             + np.array([np.amin(embed_list[5], axis=0)[0], np.amin(embed_list[5], axis=0)[1]])]) / 2
# # border_point_01 = np.array([np.array([np.amax(embed_list[0], axis=0)[0], np.mean(embed_list[0], axis=0)[1]])
# #                             + np.array([np.amin(embed_list[1], axis=0)[0], np.mean(embed_list[1], axis=0)[1]])]) / 2
# # border_point_06 = np.array([np.array([np.amax(embed_list[0], axis=0)[0], np.amin(embed_list[0], axis=0)[1]])
# #                             + np.array([np.amin(embed_list[6], axis=0)[0], np.amax(embed_list[6], axis=0)[1]])]) / 2
# # border_point_51 = np.array([np.array([np.amax(embed_list[5], axis=0)[0], np.amin(embed_list[5], axis=0)[1]])
# #                             + np.array([np.amin(embed_list[1], axis=0)[0], np.amax(embed_list[1], axis=0)[1]])]) / 2
# # border_point_53 = np.array([np.array([np.amax(embed_list[5], axis=0)[0], np.mean(embed_list[5], axis=0)[1]])
# #                             + np.array([np.amin(embed_list[3], axis=0)[0], np.mean(embed_list[3], axis=0)[1]])]) / 2
# # border_point_61 = np.array([np.array([np.amax(embed_list[6], axis=0)[0], np.amax(embed_list[6], axis=0)[1]])
# #                             + np.array([np.amin(embed_list[1], axis=0)[0], np.amin(embed_list[1], axis=0)[1]])]) / 2
# # border_point_31 = np.array([np.array([np.amin(embed_list[3], axis=0)[0], np.amin(embed_list[3], axis=0)[1]])
# #                             + np.array([np.amax(embed_list[1], axis=0)[0], np.amax(embed_list[1], axis=0)[1]])]) / 2
# # border_point_37 = np.array([np.array([np.amax(embed_list[3], axis=0)[0], np.amin(embed_list[3], axis=0)[1]])
# #                             + np.array([np.amin(embed_list[7], axis=0)[0], np.amax(embed_list[7], axis=0)[1]])]) / 2
# # border_point_71 = np.array([np.array([np.amin(embed_list[7], axis=0)[0], np.amin(embed_list[7], axis=0)[1]])
# #                             + np.array([np.amax(embed_list[1], axis=0)[0], np.amax(embed_list[1], axis=0)[1]])]) / 2
# # border_point_72 = np.array([np.array([np.amin(embed_list[7], axis=0)[0], np.amin(embed_list[7], axis=0)[1]])
# #                             + np.array([np.amax(embed_list[2], axis=0)[0], np.amax(embed_list[2], axis=0)[1]])]) / 2
# # border_point_79 = np.array([np.array([np.mean(embed_list[7], axis=0)[0], np.amin(embed_list[7], axis=0)[1]])
# #                             + np.array([np.mean(embed_list[9], axis=0)[0], np.amax(embed_list[9], axis=0)[1]])]) / 2
# # border_point_92 = np.array([np.array([np.amax(embed_list[9], axis=0)[0], np.amin(embed_list[9], axis=0)[1]])
# #                             + np.array([np.amin(embed_list[2], axis=0)[0], np.amax(embed_list[2], axis=0)[1]])]) / 2
# # border_point_94 = np.array([np.array([np.amin(embed_list[9], axis=0)[0], np.amin(embed_list[9], axis=0)[1]])
# #                             + np.array([np.amax(embed_list[4], axis=0)[0], np.amax(embed_list[4], axis=0)[1]])]) / 2
# # border_point_42 = np.array([np.array([np.mean(embed_list[4], axis=0)[0], np.amin(embed_list[4], axis=0)[1]])
# #                             + np.array([np.mean(embed_list[2], axis=0)[0], np.amax(embed_list[2], axis=0)[1]])]) / 2
# # border_point_48 = np.array([np.array([np.amin(embed_list[4], axis=0)[0], np.mean(embed_list[4], axis=0)[1]])
# #                             + np.array([np.amax(embed_list[8], axis=0)[0], np.mean(embed_list[8], axis=0)[1]])]) / 2
# # border_point_82 = np.array([np.array([np.amax(embed_list[8], axis=0)[0], np.amax(embed_list[8], axis=0)[1]])
# #                             + np.array([np.amin(embed_list[2], axis=0)[0], np.amin(embed_list[2], axis=0)[1]])]) / 2
# # border_point_81 = np.array([np.array([np.mean(embed_list[8], axis=0)[0], np.amax(embed_list[8], axis=0)[1]])
# #                             + np.array([np.mean(embed_list[1], axis=0)[0], np.amin(embed_list[1], axis=0)[1]])]) / 2
# # border_point_86 = np.array([np.array([np.amin(embed_list[8], axis=0)[0], np.amax(embed_list[8], axis=0)[1]])
# #                             + np.array([np.amax(embed_list[6], axis=0)[0], np.amin(embed_list[6], axis=0)[1]])]) / 2
# # border_point_12 = np.array([np.array([np.amax(embed_list[1], axis=0)[0], np.amin(embed_list[1], axis=0)[1]])
# #                             + np.array([np.amin(embed_list[2], axis=0)[0], np.amax(embed_list[2], axis=0)[1]])]) / 2
# # border_point_list = np.array([border_point_05, border_point_01, border_point_06, border_point_51, border_point_53,
# #                               border_point_61, border_point_31, border_point_37, border_point_71, border_point_72,
# #                               border_point_79, border_point_92, border_point_94, border_point_42, border_point_48,
# #                               border_point_82, border_point_81, border_point_86, border_point_12]).squeeze()
#
# # 3 class
...
#
# # 4 class
# # border_point_0156 = np.array([np.array([np.amax(embed_list[0], axis=0)[0], np.mean(embed_list[0], axis=0)[1]])
# #                              + np.array([np.amin(embed_list[1], axis=0)[0], np.mean(embed_list[1], axis=0)[1]])
# #                              + np.array([np.mean(embed_list[5], axis=0)[0], np.amin(embed_list[5], axis=0)[1]])
# #                              + np.array([np.mean(embed_list[6], axis=0)[0], np.amax(embed_list[6], axis=0)[1]])]) / 4
# # border_point_1357 = np.array([np.array([np.amax(embed_list[1], axis=0)[0], np.amax(embed_list[1], axis=0)[1]])
# #                              + np.array([np.mean(embed_list[3], axis=0)[0], np.amin(embed_list[3], axis=0)[1]])
# #                              + np.array([np.amax(embed_list[5], axis=0)[0], np.mean(embed_list[5], axis=0)[1]])
# #                              + np.array([np.mean(embed_list[7], axis=0)[0], np.amin(embed_list[7], axis=0)[1]])]) / 4
# # border_point_1268 = np.array([np.array([np.mean(embed_list[1], axis=0)[0], np.amin(embed_list[1], axis=0)[1]])
# #                              + np.array([np.amin(embed_list[2], axis=0)[0], np.amin(embed_list[2], axis=0)[1]])
# #                              + np.array([np.amax(embed_list[6], axis=0)[0], np.amax(embed_list[6], axis=0)[1]])
# #                              + np.array([np.mean(embed_list[8], axis=0)[0], np.amax(embed_list[8], axis=0)[1]])]) / 4
# # border_point_2479 = np.array([np.array([np.amax(embed_list[2], axis=0)[0], np.mean(embed_list[2], axis=0)[1]])
# #                              + np.array([np.amax(embed_list[4], axis=0)[0], np.amax(embed_list[4], axis=0)[1]])
# #                              + np.array([np.mean(embed_list[7], axis=0)[0], np.amin(embed_list[7], axis=0)[1]])
# #                              + np.array([np.amin(embed_list[9], axis=0)[0], np.mean(embed_list[9], axis=0)[1]])]) / 4
# # border_point_list = np.array([border_point_0156, border_point_1357, border_point_1268, border_point_2479]).squeeze()
#
...
# # border_axes = np.zeros((4, 5), dtype=object)
# border_axes = np.zeros((2, 5), dtype=object)
# # border_axes = np.zeros((1, 4), dtype=object)
# # for i in range(10):
# #     for j in range(10):
...
# # for i in range(1):
# #     for j in range(4):
# #         border_axes[i, j] = fig.add_subplot(gs[i, 4 + j])
#
...
# # for i in range(1):
# #     for j in range(4):
# #         border_axes[i, j].imshow(inv_transformed_border_points[i * 4 + j].reshape(28, 28))
